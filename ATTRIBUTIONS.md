# Substrate Open Source Attributions

This file lists all open-source libraries and licenses used by Substrate.
...
## API Module
```
github.com/KrushnaVardhanReddy/Substrate/api
cel.dev/expr v0.24.0
