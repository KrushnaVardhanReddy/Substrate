...
## Requirements
1. **Live Webhooks**: Use ngrok or a real staging environment to receive live Forgejo webhooks during tests.
...
3. **PR Interaction Tests**: Use the Forgejo API to open real PRs and validate automated bot responses.
