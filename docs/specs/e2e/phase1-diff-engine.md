...
## Objective
Validate the Phase 1 Core Diff Engine features. The tests will utilize the Full-Stack PGlite Harness (CC-T02).
...
### 2. Playwright UI Tests (`dashboard/playwright/phase1.spec.ts`)
