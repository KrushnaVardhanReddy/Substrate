...
| **P12-T12** | 🚀 P1 | **System Matrix E2E Test** — Playwright suite that runs `git push` against local Forgejo to test the Red (Breaking), Green (Safe), and Yellow (Override) paths natively end-to-end. | Jules | ⏳ Ready | `docs/specs/phase-12/p12-t12-system-matrix-e2e.md` |
