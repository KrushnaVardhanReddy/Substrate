...
| **P13-T03** | 🤯 P1 | **AI Chaos Engineering Auto-Tests** — Automatically write Playwright/Jest tests that prove an API breakage, run them in a sandbox, and post the failing test logs to the PR. | Jules | 🔄 Running (`1921896293604511419`) | `docs/specs/phase-13/p13-t03-ai-chaos-tests.md` |
