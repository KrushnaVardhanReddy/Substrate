...
| **P11-T12** | 🟡 P2 | **Rich Side-by-Side Diff Viewer (& Sign Out)** — Build an interactive, syntax-highlighted side-by-side YAML diff viewer in the dashboard to review exact line deletions. Also includes adding the global Sign Out button. | Stitch | 💡 Backlog | `docs/specs/phase-11/p11-t12-diff-viewer.md` |
| **P11-T13** | 🟢 P3 | **Time-Travel Graph Replay** — Add a timeline scrubber to the bottom of the graph to view the architectural dependencies of the enterprise exactly as they existed on any historical date. | Stitch | 💡 Backlog | `docs/specs/phase-11/p11-t13-time-travel.md` |
