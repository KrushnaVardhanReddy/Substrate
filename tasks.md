...
| **P7-T07** | 🔴 P1 | **Phase 7 E2E Testing** — Strictly "No Mocks" E2E tests for the enterprise features running against real DB and Go API instances. | Unassigned | ⏳ Ready | `docs/specs/phase-7/e2e-spec.md` |
