...
| **P9-T09** | 🟢 P3 | **AI Impact Analysis Summaries** — Pass cross-repo blast radius checks to the AI handler to generate a plain-English impact summary on PRs. | Jules | 🔄 Running (`11938830570247358518`) | `(Pending)` |
...
| **P10-T05** | ⚪ P5 | **Auto-SDK Generator PRs** — Automatically generate TypeScript/Swift/Go clients via OpenAPI Generator when a schema is merged, opening PRs directly in the downstream consumer repos. | Jules | 🔄 Running (`3496367627567881931`) | `(Pending)` |
...
| **P14-T07** | 🔴 P1 | **Phase 14 E2E Validation (No Mocks)** — Validate all new engine components (Archaeology, Contracts) end-to-end against real repositories. | Jules | 🔄 Running (`3323731011738057810`) | `docs/specs/phase-14/p14-t07-e2e-validation.md` |
...
| **P15-T13** | 🔴 P1 | **Phase 15 E2E Validation (No Mocks)** — Live orchestration testing of KMS BYOK, LLM workload routing, and Granular Check Suites against actual GitHub API and AWS/Vault environments. | Jules | 🔄 Running (`2826767874429659759`) | `(Pending)` |
