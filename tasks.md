...
| **P4-T02** | 🔴 P1 | **Streaming SSE Handler** — `POST /api/v1/ai/analyze` with real-time token streaming | Jules | 🔄 Session `4032432536007936779` | `prompts/phase-4/t02_streaming_sse_ai_handler.txt` |
| **P4-T03** | 🟡 P2 | **Safe Schema Patch Generator** — AI suggests exact YAML/SQL provider fix | Jules | 🔄 Session `4342843936538026332` | `prompts/phase-4/t03_safe_schema_patch_generator.txt` |
| **P4-T04** | 🟡 P2 | **GitHub PR Comment Upgrade** — Add AI explanation + fix snippet to PRs | Jules | 📐 Spec |
