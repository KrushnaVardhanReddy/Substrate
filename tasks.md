...
| **P11-T12** | 🟡 P2 | **Rich Side-by-Side Diff Viewer (& Sign Out)** — Build an interactive, syntax-highlighted side-by-side YAML diff viewer in the dashboard to review exact line deletions. Also includes adding the global Sign Out button. | Jules | ⏳ In Progress | `docs/specs/phase-11/p11-t12-diff-viewer.md` |
...
| **P11-T17** | 🟢 P3 | **Graph Image Export** — Allow users to export their current Svelte Flow dependency graph as a high-resolution PNG for use in RFCs and compliance audits, using `html-to-image`. | Jules | ⏳ In Progress | `docs/specs/phase-11/p11-t17-graph-export.md` |
