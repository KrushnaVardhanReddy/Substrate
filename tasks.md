...
| **P7-T05** | ⚪ P5 | **Runtime Drift Detection (eBPF/Envoy)** — Deploy a sidecar to sample 1% of live API traffic and compare it against the Substrate registry to detect un-documented payloads. | Jules | 🔄 In Progress (`11676827524367750404`) | `docs/specs/phase-7/p7-t05-runtime-drift-detection.md` |
| **P7-T06** | 🔴 P1 | **Audit Mode (Shadow Mode)** — Allow enterprises to deploy Substrate without blocking PRs. Substrate comments on PRs and logs cross-repo breaks to the dashboard, providing proof of ROI before switching to blocking mode. | Jules | 🔄 In Progress (`17256989729644084325`) | `docs/specs/phase-7/audit-mode-rollout.md` |
